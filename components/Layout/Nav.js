  ...
  return (
    <>
      <div className="h-full w-full ">
              ...
              <div className="flex flex-col justify-between h-full w-full">
                <div>
                  ...
                  <ul className="f-m-m">
                    ...
                    <li className="hidden text-gray-800 py-4 text-center font-futura text-xl">
                      <PulseDropdown />
                    </li>
        ...
        <nav className="animate-slideInDown animate-animated animate-repeat-1 animate-delay-[500ms] animate-duration-[2s]">
          {show ? (
        ...
        <div className="hidden lg:flex animate-slideInDown animate-animated animate-repeat-1 animate-delay-[500ms] animate-duration-[2s]">
          <div className="w-full">
            <nav className="h-12 items-center text-center font-molle text-base  py-4 shadow-none  px-6 w-full flex justify-between bg-th-background top-0 z-40">
              <div className="flex h-10  translate-y-0">
                <a href="/" className="w-72 mb-0">
                  <Logo />
                </a>
                <div className="font-futura text-xl w-min flex mx-auto p-2  ">
                  <SourceDropdown />
